...
npy_input_local = np.load('input_local_10.npy')
npy_input_global = np.load('input_global_10.npy')
npy_output_policy = np.load('output_policy_10.npy')
npy_output_value = np.load('output_value_10.npy')
npy_output_land = np.load('output_land_10.npy')
