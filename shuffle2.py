...
npy_input_local = np.load('input_local_00.npy')
npy_input_global = np.load('input_global_00.npy')
npy_output_policy = np.load('output_policy_00.npy')
npy_output_value = np.load('output_value_00.npy')
npy_output_land = np.load('output_land_00.npy')

npy_input_local = np.concatenate((npy_input_local, np.load('input_local_10.npy')))
npy_input_global = np.concatenate((npy_input_global, np.load('input_global_10.npy')))
npy_output_policy = np.concatenate((npy_output_policy, np.load('output_policy_10.npy')))
npy_output_value = np.concatenate((npy_output_value, np.load('output_value_10.npy')))
npy_output_land = np.concatenate((npy_output_land, np.load('output_land_10.npy')))
