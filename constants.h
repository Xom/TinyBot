...
static constexpr int kSearchThresholds[12]{32, 32, 0, 0,
                                           32, 32, 0, 0,
                                           64, 128, 0, 0};  // phases c and d use constants for b
static constexpr double kCoefsExplore[12]{20.0, 20.0, 0, 0,
                                          20.0, 20.0, 0, 0,
                                          20.0, 20.0, 0, 0};  // proportional to game score stdev / branching factor
